...
lazy_static! {
    ...
    static ref COLOR_MEMBERS: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
    static ref GUESTS: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
    static ref COLOR_GUESTS: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
    static ref COLOR_STAFF: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
    static ref COLOR_ADMINS: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
